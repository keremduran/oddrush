  ...
  <b-container class="scoreboard">
    ...
    >
      <div class="d-block info">
        ...
        set from the ones you've selected. For example if the odd is 3/2 and
        there is a 25$ bet, you need to pay 37.25$. <br /><br />Then, click on
        <b>GO</b>, and you'll see the broken-down wager and the odd at the top,
        and tray at the bottom. Start paying by selecting a color from the tray,
        and the dropcut and pay buttons will pop up on the middle left. After
        you press the dropcut buttons, your chips will appear automatically
        broken down on the middle right. <br /><br />If you want to erase chips,
        click on the left-most block to take just 1 chip and put it in the abyss
        (Nice with 95% odd for Baccarat). Clicking the other ones will erase the
        entire block. <br />(If it's unclear how many chips are there, you can
        just count the white lines.) <br /><br />On the right, there is the
